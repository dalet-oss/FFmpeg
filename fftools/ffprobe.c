...
static const OptionDef real_options[] = {
    ...
    { "select_streams",        OPT_TYPE_STRING,      0, { &stream_specifiers }, "select the specified streams, multiple stream specifiers can be separated by a comma", "stream_specifier" },
